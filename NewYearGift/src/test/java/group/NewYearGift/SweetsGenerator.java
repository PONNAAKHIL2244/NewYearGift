...
public class SweetsGenerator implements Generator<Sweets>, Iterable<Sweets> {
    ...
    public static class Logger {
		...
		public static Logger getLogger(Class<SweetsGenerator> class1) {
    ...
    private Sweets[] instances = {new WhiteChocolate(), new MilkChocolate(),
            new DarkChocolate(), new Caramel(),  new Waffles(), new Halva(),
    };
